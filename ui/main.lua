...
library.font = Font.new("rbxasset://fonts/families/Code.json")
...
function library:window(properties)
	...
	local image_thing = library:create("ImageLabel", {
		...
		Image = 'rbxassetid://114764958601571',
	...
	local list = library:create("UIGridLayout", {
	...
	local tab_inline = library:create("Frame", { -- edit this pls
		Parent = main,
		Name = "",
		Position = UDim2.new(0, 120,0, 12),
		BorderColor3 = Color3.fromRGB(19, 19, 19),
		Size = UDim2.new(1, -130,1, -20),
		BorderSizePixel = 0,
		BackgroundColor3 = Color3.fromRGB(19, 19, 19),
	})
